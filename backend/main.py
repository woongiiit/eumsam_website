...
from schemas import *
from auth import *
from routes import auth, users, posts, gallery, applications, application_form, email_test, admin, comments
...
app.include_router(comments.router, prefix="/api", tags=["댓글"])
